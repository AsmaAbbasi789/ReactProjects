...
const Resume = () => {
    ...
    const [sidebarBG, setSidebarBG] = useState("#000000");
    const [sidebarTxt, setSidebarTxt] = useState("#FFFFFF");
    ...
    const styles = {
        ...
        margin0: { margin: "0px" },
        uniName: { marginBottom: "5px", fontWeight: "bold", color: "#204D8B" },
    };
            ...
            <div style={styles.container}>
                <div style={styles.resumeRow} ref={cvTemplateRef}>
                        ...
                        <div style={styles.profile}>
                            <div style={styles.canidateName}>
                                <h2 style={{ ...styles.profileContentColor, ...styles.dFlex }}>
                                    {/* first name and last name here */info.firstName + " " + info.lastName}
                                </h2>
                            </div>
                    ...
                    <div style={styles.main}>
                        ...
                        <h2 className="heading-decorator">EXPERIENCE</h2>
                        {/* map experience here */work.experience && work.experience.map((exp) => populateExperience(exp))}

                        <h2 className="heading-decorator">EDUCATION</h2>
